...
const {Lock} = require('wmcc-mutex');
const tcp = require('wmcc-tcp');
const IP = require('wmcc-inet');
const Logger = require('wmcc-logger');
const fs = require('wmcc-file');
// todo add wmcc-crypto lib
//const hash256 = require('bcrypto/lib/hash256');
//const ccmp = require('bcrypto/lib/ccmp');
const hash256 = require('../crypto/sha256').hash256;
const ccmp = require('../crypto/ccmp');
const util = require('../utils/util');
const consensus = require('../protocol/consensus');
const List = require('../utils/list');
const Network = require('../protocol/network');
const common = require('../mining/common');
